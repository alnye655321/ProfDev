...
$result = mysqli_query($con,"SELECT * FROM Events WHERE id != '1'");
...
// Table Body SQL Select
	while($row = mysqli_fetch_array($result))
	{
		echo "<tr>";
		echo "<td>";
			echo '<form method="post" action="edit_event.php" onClick="this.submit();"><input type="hidden" name="id" type="text" value="'.$row['id'].'">
