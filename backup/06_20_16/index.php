...
// Table Body SQL Select
	while($row = mysqli_fetch_array($result))
	{
		...
		echo '</td>';
		echo '<td>
			<form class="form1" style="float:left">A: <input type="checkbox" '.$VPCheck.' name="VP" value="'.$row['id'].'"><input type="hidden" name="devType" type="text" value="'.$row['Type'].'"><input type="hidden" name="pendingCheck" type="text" value="true"></form> 
		...
		echo '</td>';
		echo '<td>
			<form class="form1" style="float:left">A: <input type="checkbox" name="Dean" value="'.$row['id'].'"><input type="hidden" name="pendingCheck" type="text" value="true"></form> 
