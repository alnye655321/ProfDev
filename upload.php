...
$target_dir = "uploads/";
$target_file = $target_dir . basename($_FILES["fileToUpload"]["name"]); //filename: uploads/All College Announcement.docx
$uploadOk = 1;
...
if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif" && $imageFileType != "pdf" && $imageFileType != "doc" && $imageFileType != "docx") {
    $uploadError = "Sorry, only JPG, JPEG, PNG, GIF, PDF, DOC, DOCX files are allowed.";
    $uploadOk = 0;
}
